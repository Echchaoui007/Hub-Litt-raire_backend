...
<footer class="bg-white dark:bg-gray-900 ">
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center"> <router-link to="/"><img class="w-52 md:w-64" src="/image/PARMEXPORT.png" alt="PARMEXPORT"></router-link>
        </span>
